    ...
    <header className="flex-row-btw-center">
      ...
      <nav>
        ...
        <a href="https://github.com/josiasaurel">
          <svg fillRule="evenodd" clipRule="evenodd" viewBox="0 0 32 32" fill="currentColor"
            strokeLinejoin="round" width="40" height="40">
            <g>
              <path
        ...
        <a href="mailto:ndjosiasaurel@gmail.com">
          <svg fillRule="evenodd" clipRule="evenodd" viewBox="0 0 32 32" fill="currentColor"
            strokeLinejoin="round" width="43" height="43">
            <g>
              <path
