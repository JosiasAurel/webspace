...
Before we get there, I'm still involved in some web development projects and will continue to be because I love developing web applications. I've included the reasons below.
...
Additionally, updates are frictionless for me and those using what I build. Oh, there's a bug? Easy! I fixed it on my side, pushed my changes, and the update is live. They need to add a new feature and do the same thing, and the next time they open the app, it's already there. The user isn't even aware that I've made some changes (unless they're visual); they keep using the app.
...
I eventually moved to an Apple Silicon MacBook, which was a big jump in terms of experience. I don't have any of these issues anymore, but I still find building web applications slower than they should be. 
...
It's both funny and sad at the same time. Doing a quick `du -h node_modules` on some projects on my laptop gives me these.
```
...
I like to have a deep or first-principles understanding (or just the right mental model) of what I'm working on. Without that, I get easily frustrated when everything looks like a black box, and I have to make a change, cross my fingers, and pray it works. 
