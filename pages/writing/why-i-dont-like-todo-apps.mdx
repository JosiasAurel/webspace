...
export const title = "Why I don't like todo apps";
export const description = "At a personal level";
...
Over all, for someone working on the computer or phone all they long, todo apps offer benefits such as syncing
your work across devices or setting reminders in case you've got a puncture on your back-head.
